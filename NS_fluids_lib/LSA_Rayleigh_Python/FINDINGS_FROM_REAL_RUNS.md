...
The remedy is to check out `0b8df42`, as Step 1 of `Running_the_Analysis_Python.md` directs. Should a later head be required for some other reason, the assertion may be located and guarded directly:
