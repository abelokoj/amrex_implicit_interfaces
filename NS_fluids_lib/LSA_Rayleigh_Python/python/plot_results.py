...
Run from `amrex_implicit_interfaces/NS_fluids_lib/LSA_Rayleigh_Python`:
    ...
    python3 python/plot_results.py --bundle runs/bundles/k0.7 --kr0 0.7
    python3 python/plot_results.py --json validation_data/validation_kr0_0.7.json
    python3 python/plot_results.py --rundir runs/k0.7_eps0.02 \\
